...
void llama_model_dflash::load_arch_tensors(llama_model_loader &) {
    ...
    tok_embd        = create_tensor(tn(LLM_TENSOR_TOKEN_EMBD,       "weight"), { n_embd, n_vocab }, TENSOR_NOT_REQUIRED | TENSOR_BORROWED);
    ...
    output   = create_tensor(tn(LLM_TENSOR_OUTPUT,     "weight"), { n_embd, n_vocab_draft }, TENSOR_NOT_REQUIRED | TENSOR_BORROWED);
