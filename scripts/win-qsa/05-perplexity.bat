...
rem each value of FAVARIANTS is one arm, see 04-fa-sparse.bat: 1 the build default, 0 dense,
rem g the gather over the union of the rows of the tile, r the gather over a one-row tile.
